...
{
public:
    std::shared_ptr<lbcrypto::FHEBase<lbcrypto::DCRTPoly>> m_ParamsGen;
    std::shared_ptr<lbcrypto::FHEBase<lbcrypto::DCRTPoly>> m_PKE;
    std::shared_ptr<lbcrypto::FHEBase<lbcrypto::DCRTPoly>> m_KeySwitch;
    std::shared_ptr<lbcrypto::FHEBase<lbcrypto::DCRTPoly>> m_PRE;
    std::shared_ptr<lbcrypto::FHEBase<lbcrypto::DCRTPoly>> m_LeveledSHE;
    std::shared_ptr<lbcrypto::FHEBase<lbcrypto::DCRTPoly>> m_AdvancedSHE;
    std::shared_ptr<lbcrypto::FHEBase<lbcrypto::DCRTPoly>> m_Multiparty;
    std::shared_ptr<lbcrypto::FHEBase<lbcrypto::DCRTPoly>> m_FHE;
    std::shared_ptr<lbcrypto::FHEBase<lbcrypto::DCRTPoly>> m_SchemeSwitch;
...
public:
    ...
    // virtual ~FHECKKSRNS_TWIN() = default;
